export const translations = {
  en: {
    ...
    seo: {
      ...
      impact: {
        title: 'Shah Seva Impact Stories | Society Charity Work in Rajasthan',
        description: 'Discover the real-world impact of Shah Seva (Dargah Saiyad Ali Shah Seva Sansthan). Our Society in India has helped over 12,500 people with food, education, and medical aid.',
      },
      gallery: {
        title: 'Shah Seva Photo Gallery | Society Activities in Bhilwara',
        description: 'View photos of Shah Seva Society activities, food distribution drives, and education support programs for poor families in Bhilwara, Rajasthan.',
      },
      contact: {
        title: 'Contact Shah Seva Society | Volunteer or Donate in India',
        description: 'Get in touch with Shah Seva (Dargah Saiyad Ali Shah Seva Sansthan). Contact us for volunteering, Society donations, or inquiries about our charity work.',
      },
      donate: {
        title: 'Donate to Shah Seva Society India | Support Poor Families',
        description: 'Support Shah Seva (Dargah Saiyad Ali Shah Seva Sansthan) by donating online. Your charity donation helps us provide food, education, and medical aid.',
      },
      faq: {
        title: 'Shah Seva FAQ | Society Donation & Charity Questions',
        description: 'Find answers to common questions about Shah Seva Society, how to donate for poor children, and how your charity donation in India is used.',
      },
      mission: {
        title: 'Shah Seva Mission & Vision | Society for Poor Families',
        description: 'Read about the mission and vision of Shah Seva (Dargah Saiyad Ali Shah Seva Sansthan). We are dedicated to serving humanity through selfless charity work.',
      },
      istikhara: {
        title: 'Shah Seva Istikhara Guide | Islamic Guidance for Decisions',
        description: 'Shah Seva provides a guide on how to perform Istikhara prayer and seek guidance from Allah for important life decisions according to Islamic teachings.',
      },
      transparency: {
        title: 'Shah Seva Transparency Report | Society Accountability',
        description: 'Review the Shah Seva transparency report to see how your Society donations are utilized for food, education, and medical aid for poor families.',
      },
      volunteer: {
        title: 'Volunteer with Shah Seva | Join Our Charity Mission',
        description: 'Join Shah Seva (Dargah Saiyad Ali Shah Seva Sansthan) as a volunteer. Help us serve poor families and children through community outreach.',
      },
    },
    categories: {
      education: {
        title: 'Shah Seva Education Donation | Empowering Bright Futures',
        h1: 'Shah Seva Education Donation: Give a Child the Gift of Learning',
        description: 'Education is the most powerful weapon to change the world. Your Shah Seva donation for education helps underprivileged children in India access quality schooling, books, and a brighter future. Sponsor a poor child education online today.',
        metaDescription: 'Donate for education in India with Shah Seva. Support underprivileged children with school fees, books, and uniforms. Your contribution helps break the cycle of poverty.',
        section1Title: 'Why Your Shah Seva Education Donation Matters',
        section1Text: 'In many parts of Rajasthan, bright children are forced to drop out of school due to financial constraints. Help Shah Seva education donation reach those who need it most.',
        cta: 'Help a Child Today'
      },
      children: {
        title: 'Shah Seva Donation for Poor Children | Save a Childhood Today',
        h1: 'Shah Seva Donation for Poor Children: Provide Hope and Opportunity',
        description: 'Every child deserves a safe childhood filled with hope. Your Shah Seva donation for poor children in India provides essential nutrition, clothing, and a supportive environment.',
        metaDescription: 'Help poor children in India with Shah Seva. Provide food, clothing, and care to underprivileged kids. Join our mission to protect and empower the next generation.',
        section1Title: 'Protecting the Most Vulnerable',
        section1Text: 'Children are the most affected by poverty. Shah Seva works on the ground to provide immediate relief and long-term care for children living in extreme hardship.',
        cta: 'Change a Child\'s Life'
      },
      medical: {
        title: 'Shah Seva Medical Help Donation | Saving Lives in India',
        h1: 'Shah Seva Medical Help Donation: Provide Life-Saving Care',
        description: 'Healthcare is a basic right, yet many families in India cannot afford even basic medicines. Your Shah Seva medical help donation funds surgeries, treatments, and health camps.',
        metaDescription: 'Support medical aid for poor families in India with Shah Seva. Your donation funds life-saving surgeries, medicines, and free health checkup camps in Rajasthan.',
        section1Title: 'Bridging the Healthcare Gap',
        section1Text: 'Shah Seva organizes free medical camps in remote villages of Rajasthan, bringing doctors and medicines to those who have no other access to healthcare.',
        cta: 'Save a Life Today'
      },
      food: {
        title: 'Shah Seva Food Donation for Poor | Ending Hunger Together',
        h1: 'Shah Seva Food Donation: No One Should Go Hungry',
        description: 'Hunger is a daily reality for thousands of families. Your Shah Seva food donation provides monthly ration kits and nutritious meals to those struggling with extreme poverty.',
        metaDescription: 'Donate for food distribution in India with Shah Seva. Help us provide monthly ration kits and nutritious meals to poor families. Join our mission to end hunger.',
        section1Title: 'Fighting Hunger on the Frontlines',
        section1Text: 'Our Shah Seva food distribution drives reach the most neglected communities, ensuring that widows, elderly, and daily wage earners have enough to eat.',
        cta: 'Feed a Family Today'
      },
      disaster: {
        title: 'Shah Seva Disaster Relief Donation | Immediate Aid',
        h1: 'Shah Seva Disaster Relief: Be the First Responder',
        description: 'When disaster strikes, every second counts. Your Shah Seva donation for disaster relief allows us to provide immediate food, shelter, and medical aid to affected families.',
        metaDescription: 'Support emergency disaster relief in India with Shah Seva. Your donation provides immediate aid, food, and shelter to families affected by natural disasters.',
        section1Title: 'Rapid Response in Times of Crisis',
        section1Text: 'Shah Seva maintains an emergency fund to ensure we can mobilize volunteers and resources within hours of a disaster, providing a lifeline to those in need.',
        cta: 'Support Relief Efforts'
      },
      orphanage: {
        title: 'Shah Seva Orphanage Support India | Caring for Children',
        h1: 'Shah Seva Orphanage Support: A Family for Every Child',
        description: 'Orphan children are among the most vulnerable. Your Shah Seva donation to our orphanage support program provides a safe home, education, and a loving environment.',
        metaDescription: 'Donate to orphanage support in India with Shah Seva. Help us provide a safe home, education, and care for orphan children. Give them a chance at a better life.',
        section1Title: 'Providing a Safe Haven',
        section1Text: 'Shah Seva supports local orphanages and care centers, ensuring that children without families receive the same opportunities and love as any other child.',
        cta: 'Support an Orphan Today'
      },
      girlChild: {
        title: 'Shah Seva Girl Child Education India | Empowering Girls',
        h1: 'Shah Seva Girl Child Education: Break the Barriers',
        description: 'Educating a girl means educating a family. Your Shah Seva donation for girl child education helps girls overcome social and financial hurdles to reach their dreams.',
        metaDescription: 'Support girl child education in India with Shah Seva. Your donation helps girls stay in school and build a better future. Empower the next generation.',
        section1Title: 'Why Educate Girls?',
        section1Text: 'Girls often face the brunt of poverty. By supporting their education through Shah Seva, we are investing in a more equitable and prosperous future for all.',
        cta: 'Support a Girl\'s Education'
      },
      cancer: {
        title: 'Shah Seva Cancer Treatment Donation | Saving Lives',
        h1: 'Shah Seva Cancer Treatment Support: Give Hope',
        description: 'Cancer treatment is expensive for many. Your Shah Seva donation for cancer patient treatment provides financial assistance for chemotherapy and medication.',
        metaDescription: 'Help cancer patients in India with Shah Seva. Provide financial support for life-saving treatments and care. Join our fight against cancer today.',
        section1Title: 'Fighting Cancer Together',
        section1Text: 'Shah Seva helps poor patients navigate the complex journey of cancer treatment, ensuring they don\'t have to fight alone.',
        cta: 'Donate for Treatment'
      },
      oldAge: {
        title: 'Shah Seva Old Age Home Support | Caring for Elders',
        h1: 'Shah Seva Old Age Home Support: Dignity in Senior Years',
        description: 'Many elderly people are left without support. Your Shah Seva donation for old age homes ensures they have a safe place to live, food, and medical attention.',
        metaDescription: 'Support old age homes in India with Shah Seva. Your donation provides care, shelter, and medical aid to abandoned elderly people. Help them live with dignity.',
        section1Title: 'Honoring Our Elders',
        section1Text: 'Shah Seva believes every senior citizen deserves to live their final years with respect and comfort. Your support makes this possible.',
        cta: 'Support Our Elders'
      },
      homeless: {
        title: 'Shah Seva Help for Homeless India | Shelter and Hope',
        h1: 'Shah Seva Help for Homeless: A Roof Over Every Head',
        description: 'Living on the streets is a harsh reality. Your Shah Seva donation for homeless people provides temporary shelter, warm blankets, and hot meals.',
        metaDescription: 'Help homeless people in India with Shah Seva. Your donation provides shelter, food, and essential supplies to those living on the streets.',
        section1Title: 'Providing Immediate Relief',
        section1Text: 'During harsh winters, Shah Seva teams work tirelessly to provide blankets and shelter to those exposed to the elements.',
    ...
    mission: {
      ...
      desc: 'Dedicated to serving humanity through compassion, transparency, and selfless service in Bhilwara, Rajasthan.',
      missionTitle: 'Our Mission',
      missionDesc: 'To provide immediate relief and long-term support to underprivileged families through food, education, and medical aid, ensuring a life of dignity for all.',
      visionTitle: 'Our Vision',
      visionDesc: 'An India where poverty does not limit potential, and every individual has access to basic necessities and opportunities for growth.',
    ...
    transparency: {
      ...
      usage: [
        { label: 'Direct Aid (Food, Medicine, Fees)', value: '85%' },
        { label: 'Program Management', value: '8%' },
        { label: 'Fundraising & Awareness', value: '4%' },
  ...
  hi: {
    ...
    stats: {
      families: 'मदद किए गए परिवार',
      meals: 'प्रदान किया गया भोजन',
      students: 'समर्थित छात्र',
    ...
    aboutSummary: {
      ...
      item4: 'शाह सेवा सपोर्ट इंडिया: सामुदायिक कल्याण प्रोजेक्ट्स',
    ...
    founder: {
      ...
      message: "हमारा मिशन करुणा और गरिमा के साथ हर जरूरतमंद आत्मा की सेवा करना है। हमारा मानना है कि मानवता की सेवा ही ईश्वर की सच्ची सेवा है। 2010 से, हम भीलवाड़ा में वंचितों के उत्थान के लिए समर्पित हैं, और आपका समर्थन ही इस यात्रा को संभव बनाता है।",
      signature: "आभार के साथ,",
    },
    activities: {
      badge: 'हमारा सोसाइटी प्रभाव',
      title: 'भारत में आपका चैरिटी दान वास्तविक बदलाव कैसे लाता है',
      desc: 'हम स्थायी प्रभाव पर ध्यान केंद्रित करते हैं। चाहे आप गरीब बच्चों की स्कूली शिक्षा के लिए दान करें या चिकित्सा राहत प्रदान करें, आपके योगदान को अत्यंत अखंडता और पारदर्शिता के साथ संभाला जाता है।',
      foodTitle: 'गरीबों के लिए दान: भूख मिटाना',
      foodDesc: 'हम पूरे भारत में अत्यधिक गरीबी से जूझ रहे परिवारों को पौष्टिक भोजन और मासिक राशन किट प्रदान करते हैं, यह सुनिश्चित करते हुए कि कोई भी भूखा न सोए।',
      eduTitle: 'सोसाइटी बच्चों की शिक्षा में मदद कर रही है',
      eduDesc: 'शिक्षा एक बेहतर भविष्य की कुंजी है। आपका समर्थन राजस्थान में वंचित छात्रों के लिए स्कूल की फीस, किताबों और वर्दी के लिए धन प्रदान करता है।',
      medTitle: 'गरीब परिवारों के लिए चिकित्सा सहायता',
      medDesc: 'हम मुफ्त स्वास्थ्य जांच शिविर आयोजित करते हैं और उन लोगों को सर्जरी और दवाओं के लिए वित्तीय सहायता प्रदान करते हैं जो भारत में स्वास्थ्य देखभाल का खर्च नहीं उठा सकते।',
      readMore: 'और प्रभाव की कहानियाँ पढ़ें',
    },
    cta: {
      title: "आपका छोटा सा योगदान किसी की दुनिया हमेशा के लिए बदल सकता है।",
      desc: 'आपके द्वारा दान किया गया प्रत्येक रुपया सीधे उन गरीब परिवारों और बच्चों के लिए भोजन, शिक्षा और चिकित्सा देखभाल में जाता है जिन्हें इसकी सबसे अधिक आवश्यकता है।',
    },
    testimonials: {
      title: 'आशा की आवाजें',
      t1: {
        name: "आयशा बेगम",
        role: "लाभार्थी",
        text: "संस्थान से मिला भोजन समर्थन हमारे सबसे कठिन समय में मेरे परिवार के लिए एक आशीर्वाद रहा है।",
      },
      t2: {
        name: "मोहम्मद इरफान",
        role: "छात्र",
        text: "उनके शिक्षा समर्थन के लिए धन्यवाद, मैं अब शिक्षक बनने के अपने सपनों को पूरा कर रहा हूँ।",
      },
      t3: {
        name: "डॉ. समीर खान",
        role: "स्वयंसेवक डॉक्टर",
        text: "मुझे उनके चिकित्सा शिविरों का हिस्सा बनने पर गर्व है। गरीबों की सेवा के प्रति समर्पण वास्तव में प्रेरणादायक है।",
      },
    },
    footer: {
      ...
      links: {
        ...
        work: 'हमारा धर्मार्थ कार्य',
        impact: 'प्रभाव की कहानियाँ',
        gallery: 'फोटो गैलरी',
        donate: 'हमारा समर्थन करें',
        mission: 'हमारा मिशन',
      ...
      newsletter: {
        title: 'न्यूज़लेटर',
        desc: 'हमारी नवीनतम गतिविधियों और प्रभाव के साथ अपडेट रहें।',
    ...
    blog: { दवाओं के लिए वित्तीय सहायता प्रदान करते हैं जो भारत में स्वास्थ्य देखभाल का खर्च नहीं उठा सकते।',
      readMore: 'और प्रभाव की कहानियाँ पढ़ें',
    },
    cta: {
      title: "आपका छोटा सा योगदान किसी की दुनिया हमेशा के लिए बदल सकता है।",
    ...
    footer: {��र्मार्थ संगठन है। हम गरीब परिवारों को भोजन, शिक्षा और चिकित्सा सहायता प्रदान करते हैं। गरीबों के लिए आपका सुरक्षित ऑनलाइन दान आज एक दुनिया बदल सकता है। जानें कि शाह सेवा के साथ सुरक्षित रूप से सोसाइटी को ऑनलाइन पैसे कैसे दान करें।',
      ctaWork: 'हमारा प्रभाव देखें',
    },
    stats: {
      families: 'मदद किए गए परिवार',
    ...
    aboutSummary: {
      ...
      desc: 'भीलवाड़ा, राजस्थान में स्थित, शाह सेवा (दरगाह सैयद अली शाह सेवा संस्थान) भारत में ऑनलाइन दान करने के लिए एक विश्वसनीय सोसाइटी है। हम वंचितों के उत्थान के लिए प्रतिबद्ध हैं। जब आप शाह सेवा के माध्यम से भारत में चैरिटी के लिए ऑनलाइन पैसे दान करते हैं, तो आप पारदर्शी और उच्च-प्रभाव वाले प्रोजेक्ट्स का समर्थन करते हैं।',
      item1: 'शाह सेवा: गरीब परिवारों के लिए दान (मासिक राशन किट)',
      item2: 'होनहार छात्रों के लिए शिक्षा दान का समर्थ�    footer: {
      desc: 'शाह सेवा (दरगाह सैयद अली शाह सेवा संस्थान) 2010 से भारत में शिक्षा, स्वास्थ्य देखभाल और सामाजिक कल्याण के माध्यम से मानवता की सेवा के लिए समर्पित है।',
      quickLinks: 'त्वरित लिंक',
      links: {
        about: 'हमारे मिशन के बारे में',
    ...
    blog: {
      title: 'हमारा ब्लॉग | शाह सेवा अंतर्दृष्टि और प्रभाव की कहानियाँ',
      desc: 'शाह सेवा की नवीनतम गतिविधियों, प्रभाव की कहानियों और सोसाइटी को ऑनलाइन पैसे कैसे दान करें, इस पर गाइड पढ़ें। जानें कि हम भारत में ऑनलाइन दान करने के लिए एक विश्वसनीय सोसाइटी क्यों हैं।',
      readMore: 'और पढ़ें',
      posts: [
        {
          id: 'how-to-donate-securely',
          title: 'शाह सेवा को ऑनलाइन सुरक्षित रूप से पैसे कैसे दान करें: एक पूर्ण गाइड',
          excerpt: 'सोच रहे हैं कि शाह सेवा को ऑनलाइन पैसे कैसे दान करें? जानें कि भारत में ऑनलाइन दान करने के लिए एक विश्वसनीय सोसाइटी के माध्यम से अपना दान सुरक्षित रूप से कैसे पहुँचाया जाए।',
          date: '1 अप्रैल, 2026',
          category: 'गाइड'
        },
        {
          id: 'impact-of-education-donation',
          title: 'गरीब बच्चों के लिए शाह सेवा शिक्षा दान का प्रभाव',
          excerpt: 'जानें कि कैसे आप शाह सेवा के माध्यम से भारत में ऑनलाइन चैरिटी के लिए पैसे दान कर सकते हैं ताकि एक बच्चे की शिक्षा को प्रायोजित किया जा सके।',
          date: '25 मार्च, 2026',
          category: 'शिक्षा'
        },
        {
          id: 'supporting-cancer-patients',
          title: 'कैंसर रोगियों की सहायता: शाह सेवा एक विश्वसनीय सोसाइटी क्यों है',
          excerpt: 'गरीब मरीजों के लिए चिकित्सा सहायता कैसे बदलाव ला रही है, इसकी वास्तविक कहानियाँ। शाह सेवा को ऑनलाइन पैसे कैसे दान करें, इसके बारे में जानें।',
          date: '15 मार्च, 2026',
          category: 'चिकित्सा'
        }
      ]
    ...
    seo: {
      ...
      about: {
        title: 'शाह सेवा के बारे में | भारत में विश्वसनीय चैरिटी संगठन',
        description: 'शाह सेवा (दरगाह सैयद अली शाह सेवा संस्थान) के बारे में जानें। हमारा मिशन निस्वार्थ धर्मार्थ कार्य के माध्यम से गरीब परिवारों और बच्चों की सेवा करना है।',
      },
      work: {
        title: 'शाह सेवा धर्मार्थ कार्य | भारत में गरीब परिवारों के लिए सोसाइटी सहायता',
        description: 'शाह सेवा पहलों का अन्वेषण करें, जिसमें राजस्थान में गरीब परिवारों और बच्चों के लिए भोजन वितरण, शिक्षा सहायता और चिकित्सा सहायता शामिल है।',
      },
      impact: {
        title: 'शाह सेवा प्रभाव की कहानियाँ | राजस्थान में चैरिटी कार्य',
        description: 'शाह सेवा (दरगाह सैयद अली शाह सेवा संस्थान) के वास्तविक दुनिया के प्रभाव की खोज करें। हमारी सोसाइटी ने भोजन, शिक्षा और चिकित्सा सहायता के साथ 12,500 से अधिक लोगों की मदद की है।',
      },
      gallery: {
        title: 'शाह सेवा फोटो गैलरी | भीलवाड़ा, राजस्थान में सोसाइटी गतिविधियाँ',
        description: 'भीलवाड़ा, राजस्थान में शाह सेवा सोसाइटी गतिविधियाँ, भोजन वितरण अभियानों और शिक्षा सहायता कार्यक्रमों की तस्वीरें देखें।',
      },
      contact: {
        title: 'शाह सेवा से संपर्क करें | भारत में स्वयंसेवक बनें या दान करें',
        description: 'शाह सेवा (दरगाह सैयद अली शाह सेवा संस्थान) के साथ जुड़ें। राजस्थान में स्वयंसेवा, सोसाइटी दान या हमारे धर्मार्थ कार्य के बारे में पूछताछ के लिए हमसे संपर्क करें।',
      },
      donate: {
        title: 'शाह सेवा इंडिया को दान दें | गरीब परिवारों और बच्चों का समर्थन करें',
        description: 'ऑनलाइन दान करके शाह सेवा (दरगाह सैयद अली शाह सेवा संस्थान) का समर्थन करें। आपका दान हमें गरीब परिवारों को भोजन, शिक्षा और चिकित्सा सहायता प्रदान करने में मदद करता है।',
      },
      faq: {
        title: 'शाह सेवा अक्सर पूछे जाने वाले प्रश्न | सोसाइटी दान और चैरिटी प्रश्न',
        description: 'शाह सेवा के बारे में सामान्य प्रश्नों के उत्तर खोजें, गरीब बच्चों के लिए दान कैसे करें, और भारत में आपके दान का उपयोग सामाजिक कल्याण के लिए कैसे किया जाता है।',
      },
      mission: {
        title: 'शाह सेवा मिशन और विजन | भारत में गरीब परिवारों के लिए सोसाइटी',
        description: 'शाह सेवा (दरगाह सैयद अली शाह सेवा संस्थान) के मिशन और विजन के बारे में पढ़ें। हम निस्वार्थ धर्मार्थ कार्य के माध्यम से मानवता की सेवा के लिए समर्पित हैं।',
      },
      istikhara: {
        title: 'शाह सेवा इस्तखारा गाइड | निर्णयों के लिए इस्लामी मार्गदर्शन',
        description: 'शाह सेवा के साथ प्रामाणिक इस्लामी शिक्षाओं के अनुसार इस्तखारा की नमाज़ पढ़ना और महत्वपूर्ण जीवन निर्णयों के लिए अल्लाह से मार्गदर्शन मांगना सीखें।',
      },
      transparency: {
        title: 'शाह सेवा पारदर्शिता रिपोर्ट | भारत में सोसाइटी जवाबदेही',
        description: 'यह देखने के लिए शाह सेवा पारदर्शिता रिपोर्ट की समीक्षा करें कि आपके सोसाइटी दान का उपयोग भारत में गरीब परिवारों के लिए कैसे किया जाता है।',
      },
      volunteer: {
        title: 'शाह सेवा के साथ स्वयंसेवक बनें | भारत में हमारे चैरिटी मिशन में शामिल हों',
        description: 'एक स्वयंसेवक के रूप में शाह सेवा (दरगाह सैयद अली शाह सेवा संस्थान) में शामिल हों। सामुदायिक आउटरीच के माध्यम से गरीब परिवारों की सेवा करने में हमारी मदद करें।',
      },
    },
    categories: {
      education: {
        title: 'शाह सेवा शिक्षा दान | उज्ज्वल भविष्य को सशक्त बनाना',
        h1: 'शाह सेवा शिक्षा दान: एक बच्चे को सीखने का उपहार दें',
        description: 'शिक्षा दुनिया को बदलने का सबसे शक्तिशाली हथियार है। शाह सेवा के लिए आपका शिक्षा दान भारत में वंचित बच्चों को गुणवत्तापूर्ण स्कूली शिक्षा और उज्ज्वल भविष्य प्राप्त करने में मदद करता है।',
        metaDescription: 'शाह सेवा के साथ भारत में शिक्षा के लिए दान करें। स्कूल की फीस, किताबों और वर्दी के साथ वंचित बच्चों का समर्थन करें। आपका योगदान गरीबी के चक्र को तोड़ने में मदद करता है।',
        section1Title: 'आपका शाह सेवा शिक्षा दान क्यों मायने रखता है',
        section1Text: 'राजस्थान के कई हिस्सों में, होनहार बच्चों को वित्तीय बाधाओं के कारण स्कूल छोड़ने के लिए मजबूर होना पड़ता है। शाह सेवा का समर्थन सुनिश्चित करता है कि वे कक्षा में रहें।',
        cta: 'आज ही एक बच्चे की मदद करें'
      },
      children: {
        title: 'शाह सेवा गरीब बच्चों के लिए दान | आज ही एक बचपन बचाएं',
        h1: 'शाह सेवा गरीब बच्चों के लिए दान: आशा और अवसर प्रदान करें',
        description: 'हर बच्चा आशा से भरे सुरक्षित बचपन का हकदार है। शाह सेवा के लिए आपका दान जरूरतमंदों के लिए आवश्यक पोषण, कपड़े और एक सहायक वातावरण प्रदान करता है।',
        metaDescription: 'शाह सेवा के साथ भारत में गरीब बच्चों की मदद करें। वंचित बच्चों को भोजन, कपड़े और देखभाल प्रदान करें। अगली पीढ़ी को सशक्त बनाने के हमारे मिशन में शामिल हों।',
        section1Title: 'सबसे कमजोर लोगों की रक्षा करना',
        section1Text: 'बच्चे गरीबी से सबसे अधिक प्रभावित होते हैं। शाह सेवा अत्यधिक कठिनाई में रहने वाले बच्चों के लिए तत्काल राहत और दीर्घकालिक देखभाल प्रदान करने के लिए काम करती है।',
        cta: 'एक बच्चे का जीवन बदलें'
      },
      medical: {
        title: 'शाह सेवा चिकित्सा सहायता दान | भारत में जीवन बचाना',
        h1: 'शाह सेवा चिकित्सा सहायता दान: जीवन रक्षक देखभाल प्रदान करें',
        description: 'स्वास्थ्य देखभाल एक बुनियादी अधिकार है। शाह सेवा के लिए आपका चिकित्सा सहायता दान सर्जरी, उपचार और स्वास्थ्य शिविरों के लिए धन प्रदान करता है।',
        metaDescription: 'शाह सेवा के साथ भारत में गरीब परिवारों के लिए चिकित्सा सहायता का समर्थन करें। आपका दान राजस्थान में जीवन रक्षक सर्जरी और मुफ्त स्वास्थ्य जांच शिविरों के लिए धन प्रदान करता है।',
        section1Title: 'स्वास्थ्य देखभाल के अंतर को पाटना',
        section1Text: 'शाह सेवा राजस्थान के दूरदराज के गांवों में मुफ्त चिकित्सा शिविर आयोजित करती है, उन लोगों तक डॉक्टरों और दवाओं को पहुँचाती है जिनके पास कोई अन्य साधन नहीं है।',
        cta: 'आज ही एक जीवन बचाएं'
      },
      food: {
        title: 'शाह सेवा गरीबों के लिए भोजन दान | मिलकर भूख मिटाएं',
        h1: 'शाह सेवा भोजन वितरण दान: कोई भी भूखा नहीं रहना चाहिए',
        description: 'हजारों परिवारों के लिए भूख एक दैनिक वास्तविकता है। शाह सेवा के लिए आपका भोजन दान अत्यधिक गरीबी से जूझ रहे लोगों को मासिक राशन किट और पौष्टिक भोजन प्रदान करता है।',
        metaDescription: 'शाह सेवा के साथ भारत में भोजन वितरण के लिए दान करें। गरीब परिवारों को मासिक राशन किट प्रदान करने में हमारी मदद करें। राजस्थान में भूख मिटाने के हमारे मिशन में शामिल हों।',
        section1Title: 'अग्रिम पंक्ति में भूख से लड़ना',
        section1Text: 'शाह सेवा भोजन वितरण अभियान सबसे उपेक्षित समुदायों तक पहुँचता है, यह सुनिश्चित करता है कि विधवाओं और बुजुर्गों के पास खाने के लिए पर्याप्त हो।',
        cta: 'आज ही एक परिवार को खिलाएं'
      },
      disaster: {
        title: 'शाह सेवा आपदा राहत दान | तत्काल सहायता',
        h1: 'शाह सेवा आपदा राहत दान: प्रथम प्रतिक्रियाकर्ता बनें',
        description: 'जब आपदा आती है, तो हर सेकंड मायने रखता है। शाह सेवा के लिए आपका आपदा राहत दान हमें प्रभावित परिवारों को तत्काल भोजन, आश्रय और चिकित्सा सहायता प्रदान करने की अनुमति देता है।',
        metaDescription: 'शाह सेवा के साथ भारत में आपातकालीन आपदा राहत का समर्थन करें। आपका दान प्राकृतिक आपदाओं से प्रभावित परिवारों को तत्काल सहायता और भोजन प्रदान करता है।',
        section1Title: 'संकट के समय में त्वरित प्रतिक्रिया',
        section1Text: 'शाह सेवा एक आपातकालीन कोष बनाए रखती है ताकि हम आपदा के कुछ घंटों के भीतर स्वयंसेवकों और संसाधनों को जुटा सकें।',
        cta: 'राहत प्रयासों का समर्थन करें'
      },
      orphanage: {
        title: 'शाह सेवा अनाथालय सहायता भारत | बच्चों की देखभाल',
        h1: 'शाह सेवा अनाथालय सहायता: हर बच्चे के लिए एक परिवार',
        description: 'अनाथ बच्चे हमारे समाज में सबसे कमजोर लोगों में से हैं। शाह सेवा अनाथालय सहायता कार्यक्रम के लिए आपका दान एक सुरक्षित घर, शिक्षा और प्यार भरा वातावरण प्रदान करता है।',
        metaDescription: 'शाह सेवा के साथ भारत में अनाथालय सहायता के लिए दान करें। अनाथ बच्चों के लिए एक सुरक्षित घर और शिक्षा प्रदान करने में हमारी मदद करें।',
        section1Title: 'एक सुरक्षित ठिकाना प्रदान करना',
        section1Text: 'शाह सेवा स्थानीय अनाथालयों का समर्थन करती है, यह सुनिश्चित करती है कि बिना परिवार के बच्चों को समान अवसर और प्यार मिले।',
        cta: 'आज ही एक अनाथ का समर्थन करें'
      },
      girlChild: {
        title: 'शाह सेवा बालिका शिक्षा भारत | बालिकाओं को सशक्त बनाना',
        h1: 'शाह सेवा बालिका शिक्षा भारत: बाधाओं को तोड़ें',
        description: 'एक लड़की को शिक्षित करने का अर्थ है एक परिवार को शिक्षित करना। शाह सेवा बालिका शिक्षा के लिए आपका दान लड़कियों को सामाजिक और वित्तीय बाधाओं को दूर करने में मदद करता है।',
        metaDescription: 'शाह सेवा के साथ भारत में बालिका शिक्षा का समर्थन करें। आपका दान लड़कियों को स्कूल में रहने और बेहतर भविष्य बनाने में मदद करता है।',
        section1Title: 'लड़कियों को क्यों शिक्षित करें?',
        section1Text: 'लड़कियां अक्सर गरीबी का खामियाजा भुगतती हैं। शाह सेवा के माध्यम से उनकी शिक्षा का समर्थन करके, हम एक समृद्ध भविष्य में निवेश कर रहे हैं।',
        cta: 'एक लड़की की शिक्षा का समर्थन करें'
      },
      cancer: {
        title: 'शाह सेवा कैंसर रोगी उपचार भारत | जीवन बचाना',
        h1: 'शाह सेवा कैंसर रोगी उपचार भारत: आशा दें',
        description: 'कैंसर का इलाज कई लोगों के लिए बहुत महंगा है। शाह सेवा कैंसर रोगी उपचार के लिए आपका दान कीमोथेरेपी और दवाओं के लिए वित्तीय सहायता प्रदान करता है।',
        metaDescription: 'शाह सेवा के साथ भारत में कैंसर रोगियों की मदद करें। जीवन रक्षक उपचार और देखभाल के लिए वित्तीय सहायता प्रदान करें।',
        section1Title: 'कैंसर से मिलकर लड़ना',
        section1Text: 'शाह सेवा गरीब मरीजों को कैंसर उपचार की जटिल यात्रा में मदद करती है, यह सुनिश्चित करती है कि उन्हें अकेले नहीं लड़ना पड़े।',
        cta: 'उपचार के लिए दान करें'
      },
      oldAge: {
        title: 'शाह सेवा वृद्धाश्रम भारत | बुजुर्गों की देखभाल',
        h1: 'शाह सेवा वृद्धाश्रम भारत: वरिष्ठ वर्षों में गरिमा',
        description: 'कई बुजुर्गों को सहायता के बिना छोड़ दिया जाता है। शाह सेवा वृद्धाश्रम के लिए आपका दान सुनिश्चित करता है कि उनके पास सुरक्षित जगह, भोजन और चिकित्सा ध्यान हो।',
        metaDescription: 'शाह सेवा के साथ भारत में वृद्धाश्रमों का समर्थन करें। आपका दान परित्यक्त बुजुर्गों को देखभाल, आश्रय और चिकित्सा सहायता प्रदान करता है।',
        section1Title: 'हमारे बुजुर्गों का सम्मान करना',
        section1Text: 'शाह सेवा का मानना है कि हर वरिष्ठ नागरिक सम्मान के साथ अपने अंतिम वर्ष जीने का हकदार है। आपका समर्थन इसे संभव बनाता है।',
        cta: 'हमारे बुजुर्गों का समर्थन करें'
      },
      homeless: {
        title: 'शाह सेवा बेघर लोगों के लिए दान भारत | आश्रय और आशा',
        h1: 'शाह सेवा बेघर लोगों के लिए दान भारत: हर सिर पर छत',
        description: 'सड़कों पर रहना कई लोगों के लिए एक कड़वी सच्चाई है। शाह सेवा बेघर लोगों के लिए आपका दान अस्थायी आश्रय, गर्म कंबल और भोजन प्रदान करता है।',
        metaDescription: 'शाह सेवा के साथ भारत में बेघर लोगों की मदद करें। आपका दान सड़कों पर रहने वालों को आश्रय और भोजन प्रदान करता है।',
        section1Title: 'तत्काल राहत प्रदान करना',
        section1Text: 'कड़ाके की ठंड के दौरान, शाह सेवा टीमें उन लोगों को कंबल और आश्रय प्रदान करने के लिए अथक प्रयास करती हैं जो तत्वों के संपर्क में हैं।',
        cta: 'बेघरों की मदद करें'
      }
    },� के माध्यम से उनकी शिक्षा का समर्थन करके, हम एक समृद्ध भविष्य में निवेश कर रहे हैं।',
        cta: 'एक लड़की की शिक्षा का समर्थन करें'
      },
      cancer: {
        title: 'शाह सेवा कैंसर रोगी उपचार भारत | जीवन बचाना',
    ...
    donation: {
      ...
      successMsg: 'आपके उदार योगदान के लिए धन्यवाद। आपका समर्थन हमारे लिए बहुत मायने रखता है।',
      instructionMsg: 'आपका उदार दान हमें गरीबों और जरूरतमंदों की सेवा करने के हमारे मिशन को जारी रखने में मदद करता है। कृपया आगे बढ़ने के लिए अपना विवरण प्रदान करें।',
      donorDetails: 'दाता का विवरण',
      fullName: 'पूरा नाम',
      phone: 'फ़ोन नंबर',
      email: 'ईमेल पता (वैकल्पिक)',
      campaign: 'अभियान चुनें (वैकल्पिक)',
      general: 'सामान्य दान',
      amount: 'दान राशि (₹)',
      processing: 'प्रसंस्करण...',
      verifying: 'भुगतान का सत्यापन किया जा रहा है...',
      generateQR: 'भुगतान क्यूआर जेनरेट करें',
      detailsRecorded: 'विवरण दर्ज किया गया!',
      qrInstruction: 'अपना दान पूरा करने के लिए कृपया दाईं ओर दिए गए क्यूआर कोड को स्कैन करें।',
      completed: 'मैंने भुगतान पूरा कर लिया है',
      edit: 'विवरण संपादित करें',
      confidential: 'आपका विवरण गोपनीय रखा जाता है और केवल दान रिकॉर्ड के लिए उपयोग किया जाता है।',
      scanToDonate: 'दान करने के लिए स्कैन करें',
      qrPlaceholder: 'भुगतान क्यूआर कोड जेनरेट करने के लिए अपना विवरण भरें।',
      qrInstructionText: 'अपना भुगतान पूरा करने के लिए किसी भी यूपीआई ऐप से इस क्यूआर कोड को स्कैन करें।',
      scanWithAny: 'किसी भी यूपीआई ऐप से स्कैन करें',
      qrWillAppear: 'क्यूआर यहाँ दिखाई देगा',
      upiId: 'यूपीआई आईडी',
      payDirectly: 'ऐप के माध्यम से सीधे भुगतान करें',
      whyDonate: 'दान क्यों करें?',
      reasons: [
        'आपके दान का 100% धर्मार्थ कार्य में जाता है।',
        'भोजन, शिक्षा और स्वास्थ्य देखभाल के लिए सहायता।',
        'जरूरतमंद अधिक परिवारों तक पहुँचने में हमारी मदद करें।',
        'आपके पैसे का उपयोग कैसे किया जाता है, इस पर नियमित अपडेट।',
      ],
      thankYou: 'धन्यवाद',
      initiated: 'शुरू कर दिया गया है। हमारी टीम लेनदेन का सत्यापन करेगी और हमारे रिकॉर्ड अपडेट करेगी।',
      confirmationSent: 'एक पुष्टिकरण संदेश जल्द ही भेजा जाएगा',
      shortly: '।',
      backHome: 'होम पर वापस जाएं',
      impactSection: {
        title: 'आपके दान का प्रभाव',
        items: [
          { amount: '₹500', desc: 'एक परिवार के लिए एक सप्ताह का पौष्टिक भोजन प्रदान कर सकता है।' },
          { amount: '₹1000', desc: 'एक छात्र के लिए आवश्यक किताबें और स्टेशनरी प्रदान कर सकता है।' },
          { amount: '₹2500', desc: 'एक बच्चे के लिए पूरे महीने की शिक्षा फीस कवर कर सकता है।' },
          { amount: '₹5000', desc: 'महत्वपूर्ण चिकित्सा सहायता या स्वास्थ्य जांच शिविर प्रदान कर सकता है।' },
        ],
      },
    },
    about: {
      ...
      values: {
        compassion: {
          title: 'करुणा',
          desc: 'हर चैरिटी प्रोजेक्ट में दयालुता के साथ कार्य करना।',
        },
        transparency: {
          title: 'पारदर्शिता',
        ...
        integrity: {
          title: 'अखंडता',
          desc: 'हमारे काम में ईमानदारी और मजबूत नैतिक सिद्धांत।',
        },
        service: {
          title: 'सेवा',
          desc: 'गरीब परिवारों की मदद के लिए निस्वार्थ समर्पण।',
        },
      },
    },
    contact: {
      title: 'संपर्क करें',
      desc: 'प्रश्न हैं या स्वयंसेवक बनना चाहते हैं? हमसे संपर्क करें। हमें आपसे सुनना अच्छा लगेगा।',
      detailsTitle: 'संपर्क विवरण',
      address: 'पता',
      addressText: 'मुराद अली दरगाह के पास, खेल मोहल्ला, पुर, भीलवाड़ा राजस्थान',
      phone: 'फ़ोन',
      email: 'ईमेल',
      whatsappText: 'त्वरित प्रतिक्रिया के लिए व्हाट्सएप पर हमारे साथ चैट करें:',
